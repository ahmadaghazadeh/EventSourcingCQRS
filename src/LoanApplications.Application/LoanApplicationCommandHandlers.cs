...
namespace LoanApplications.Application
{
	public class LoanApplicationHandlers :
		ICommandHandler<PlaceLoanApplicationCommand>,
		...
		ICommandHandler<RejectApplicationCommand>
	{
		...
		public async Task Handle(RejectApplicationCommand command, CancellationToken cancellationToken)
		{
			var loanApplication = await _repository.Get(new LoanApplicationId(command.LoanApplicationId));
		...
		public async Task Handle(PlaceLoanApplicationCommand cmd, CancellationToken cancellationToken)
		{
